      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Card>
          ...
          <CardContent className="space-y-6 text-muted-foreground prose prose-invert max-w-none">
            <p>
              En Rangel Guitar Hub, accesible desde rangel-guitar.com, una de nuestras principales prioridades es la privacidad de nuestros visitantes. Este documento de Política de Privacidad contiene tipos de información que son recopilados y registrados por Rangel Guitar Hub y cómo la usamos.
            </p>
