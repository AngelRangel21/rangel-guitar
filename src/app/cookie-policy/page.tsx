        ...
        <Card>
          ...
          <CardContent className="space-y-6 text-muted-foreground prose prose-invert max-w-none">
            ...
            <p>
              ...
              experiencia mientras navega por el sitio web. De estas, las
              cookies que se clasifican como necesarias se almacenan en su
            ...
            <p>
              ...
              visita colocan en su computadora. Se utilizan ampliamente para que
            ...
            <p>
              Utilizamos cookies para una variedad de propósitos detallados a
            ...
            <p>
              Puede evitar la instalación de cookies ajustando la configuración
              ...
              desactivación de cookies generalmente resultará también en la
              desactivación de ciertas funcionalidades y características de este
              sitio.
            </p>
          </CardContent>
        </Card>
