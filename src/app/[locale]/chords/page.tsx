...
export const metadata: Metadata = {
  ...
  description:
    'Explora una biblioteca completa de acordes de guitarra. Encuentra diagramas para acordes mayores, menores y de séptima para mejorar tu forma de tocar.',
  openGraph: {
    title: 'Biblioteca de Acordes | Rangel Guitar',
    description:
      'Explora una biblioteca completa de acordes de guitarra en Rangel Guitar.',
    images: [
      {
 ...
 */
export default function ChordsPage(): JSX.Element {
  return (
