        ...
        <Card>
          ...
          <CardContent className="space-y-6 text-muted-foreground prose prose-invert max-w-none">
            ...
            <p>
              ...
              nosotros en Rangel Guitar. Hemos implementado una variedad de
              medidas de seguridad para mantener la seguridad de su información
            ...
            <p>
              Utilizamos encriptación SSL (Secure Socket Layer) para proteger
              sus datos durante la transmisión. Sus datos personales se
              almacenan detrás de redes seguras y solo son accesibles por un
              número limitado de personas que tienen derechos de acceso
            ...
            <p>
              Las contraseñas de los usuarios se almacenan utilizando algoritmos
              de hash seguros. Nunca almacenamos contraseñas en texto plano. Es
            ...
            <p>
              Trabajamos con proveedores de servicios de confianza, como
              Firebase de Google para la autenticación, que cumplen con los más
              altos estándares de seguridad de la industria para proteger sus
              datos.
            </p>
          </CardContent>
        </Card>
