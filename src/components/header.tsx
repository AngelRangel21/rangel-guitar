...
import { Menu, Music, Search, LogOut, Globe, Heart, GitPullRequest, Shield, Bell, X, GraduationCap, FilePlus2, Wand2, PenSquare } from "lucide-react";
              ...
              {isAuthenticated && user ? (
                <>
                  ...
                  <DropdownMenuItem asChild>
                   ...
                   <DropdownMenuItem asChild>
                    <Link href="/premium/lyric-assistant" className="flex w-full items-center justify-between">
                      <div className="flex items-center">
                        <PenSquare className="mr-2 h-4 w-4" />
                        <span>{t('lyricAssistant')}</span>
                      </div>
