...
export const guitarChordShapes: ChordShapes = {
  ...
  A: [
    ...
    { positions: ["x", "x", 7, 6, 5, 5], baseFret: 5 },
  ],
  "A#": [{ positions: ["x", 1, 3, 3, 3, 1], baseFret: 1 }],
  B: [{ positions: ["x", 2, 4, 4, 4, 2], baseFret: 2 }],
  C: [
    { positions: ["x", 3, 2, 0, 1, 0] },
    { positions: ["x", 3, 5, 5, 5, 3], baseFret: 3 }, // Variación con cejilla
  ],
  "C#": [{ positions: ["x", 4, 3, 1, 2, 1], baseFret: 1 }],
  D: [
    { positions: ["x", "x", 0, 2, 3, 2] },
    { positions: ["x", 5, 4, 7, "x", "x"], baseFret: 4 },
  ],
  "D#": [
    { positions: ["x", "x", 1, 3, 4, 3], baseFret: 1 },
    { positions: ["x", 6, 5, 8, "x", "x"], baseFret: 5 },
  ],
  ...
  Cmaj7: [
    { positions: ["x", 3, 2, 0, 0, 0] },
    { positions: ["x", 3, 5, 4, 5, 3], baseFret: 3 }, // Variación
  ],
};
...
export const keyboardChordNotes: KeyboardChordNotes = {
  ...
  F7: [["F", "A", "C", "Eb"]],
  "F#7": [["F#", "A#", "C#", "E"]],
  Gb7: [["Gb", "Bb", "Db", "E"]], // E es el enarmónico de Fb
  G7: [["G", "B", "D", "F"]],
  "G#7": [["G#", "C", "D#", "F#"]],
  Ab7: [["Ab", "C", "Eb", "Gb"]],
  Cmaj7: [["C", "E", "G", "B"]],
